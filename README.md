...
AccessHub is a JWT-based authentication and role-based authorization system built with Spring Boot. It demonstrates secure user authentication, session handling, and controlled access to protected routes based on roles.
